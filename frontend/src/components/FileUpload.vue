  ...
  <div class="file-upload">
    <div class="input-group mb-3">
        <div class="custom-file">
            <input type="file" @change="onFileChange" class="custom-file-input" id="inputGroupFile02"/>
            <label id="status1" class="custom-file-label text-left" 
            for="inputGroupFile02">Choose File</label>
        </div>
        <div class="input-group-append">
            <button type="button" @click="onUploadFile" class="btn btn-primary upload-button input-group-text"
